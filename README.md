...
gantt
    ...
    와이어프레임ppt : active, 2021-05-17, 1d
    ...
    로그인/회원가입/비번찾기 페이지 백연결 + 토큰 : crit, 2021-05-12, 3d
    마이페이지 : done, 2021-04-26, 5d
    마이페이지 백연결 : crit, 2021-05-09, 4d
    정보공유 게시판 : done, 2021-04-26, 4d
    Qna 게시판 : done, 2021-05-02, 8d
    코드공유 게시판 : done, 2021-04-30, 8d
    게시판 백연결 : crit, 2021-05-08, 4d
    플래너 + 백연결 : crit, 2021-05-07, 8d
    명예의 전당 + 백연결 : done, 2021-05-07, 1d
    방명록 + 백연결 : crit, 2021-05-13, 1d
