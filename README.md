...
gantt
    ...
    로그인/회원가입/비번찾기 페이지 백연결+토큰 : active, 2021-05-05, 3d
    마이페이지 : done, 2021-04-26, 5d
    마이페이지 백연결 : active, 2021-05-05, 1d
    정보공유 게시판 : done, 2021-04-26, 4d
    Qna 게시판 : crit, 2021-04-30, 5d
    코드공유 게시판 : crit, 2021-05-01, 5d
    게시판 백연결 : active, 2021-05-06, 2d
    플래너 + 백연결 : active, 2021-05-04, 5d
    
    section Backend
    배포하기 : crit, 2021-05-06, 2d
    ...
    Qna 게시판 + 댓글 : crit 2021-05-04, 1d
    코드공유 게시판 + 명예의 전당 : crit, 2021-05-04, 1d 
    
    section Game
	네트워크 동기화 : done, 2021-04-22, 3d
	로컬 리모트 및 호스트 : done, 2021-04-23 1d
	채팅 : done, 2021-04-24, 2d
	로비 구현 : crit, 2021-04-27, 10d
    방 리스트 : done, 2021-04-24, 4d
    게임(운동장) : active, 2021-05-05,3d
    유니티 보완작업 : crit, 2021-04-28, 10d
