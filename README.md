...
gantt
    ...
    유트브 : active, 2021-04-29, 3d
    로그인/회원가입/비번찾기 페이지 : crit, 2021-04-27, 4d
    로그인/회원가입/비번찾기 페이지 백연결 : active, 2021-05-02, 3d
    마이페이지 : crit, 2021-04-26, 5d
    마이페이지 백연결 : active, 2021-05-02, 2d
    정보공유 게시판 : done, 2021-04-26, 4d
    Qna 게시판 : crit, 2021-04-30, 3d
    코드공유 게시판 : crit, 2021-05-01, 3d
    
    section Backend
    배포하기 : crit, 2021-05-03, 2d
    DB설계 : done, 2021-04-21, 2d
    매핑관계 설정 : done, 2021-04-28, 1d
    유저 CRUD : crit, 2021-04-30, 2d
    게시판 CRUD : crit, 2021-04-30, 3d
